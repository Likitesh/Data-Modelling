-- Creating a DataBase
create schema X_Mart;

-- using the DB created
use X_Mart;
...
-- Creating order and product maping table
...
-- Creating other dimensional tables
...
(order_id) references order_product_mapping (order_id);
